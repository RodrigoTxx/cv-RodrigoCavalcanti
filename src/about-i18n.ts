...
export const aboutContent = {
  es: {
    ...
    timeline: [
      { period: 'Atual', role: 'Software Engineer', company: 'Sua empresa atual', desc: 'Desenvolvimento de produtos e solucoes digitais' },
      { period: 'Anterior', role: 'Product / Tech', company: 'Experiencias anteriores', desc: 'Entrega de projetos com impacto em negocio' },
    ],
  ...
  en: {
    ...
    timeline: [
      { period: 'Current', role: 'Software Engineer', company: 'Your current company', desc: 'Building digital products and software solutions' },
      { period: 'Previous', role: 'Product / Tech', company: 'Past experiences', desc: 'Delivering projects with business impact' },
    ],
